...
<script>
    ...
    $(document).ready(function() {
      ...
      $("#tahun, #kec_kd, #kel_kd, #buku, #tahun_sppt1, #tahun_sppt2").change(function(){
         var tahun = $("#tahun").val();
         ...
         var buku = $("#buku").val();
         window.location = "<?=active_module_url().'tranmonths/'?>?tahun="+ tahun +"&tahun_sppt1="+ tahun_sppt1 +"&tahun_sppt2="+ tahun_sppt2+ "&kec_kd=" + kec_kd +"&kel_kd=" + kel_kd + "&buku=" + buku;
      });
...
<div class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs" id="myTab">
            <li class="active"><a data-toggle="tab" href="#transaksi">Transaksi Pembayaran - Rekap Bulanan</a></li>
        </ul>
