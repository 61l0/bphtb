...
function cek_piutang(nop) {
    var ret = 0;
    $.ajax({
        url: "<?=active_module_url($this->uri->segment(2));?>cek_piutang/" + nop,
        async: false,
...
function calculate_old() {
    ...
    if (vx1 > njop || perolehan==8) // perolehan 8 => Penunjukan Pembeli Dalam Lelang
...
$(document).ready(function () {
    ...
    $("#myform").submit(function () {
        var nop = $('#nop_thn').val();
        var piutang = cek_piutang(nop);

        if(piutang > 0) {
            alert('Ada pembayaran yang belum dilakukan! Silahkan lunasi terlebih dahulu.');
            return false;
        }
                        ...
                        <div class="row">
                            <div class="span4" style="width:340px;">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="checkbox" name="mutasi_penuh" <? echo $dt['mutasi_penuh']?'checked':''; ?>>
                                    </div>
                                </div>
                            </div>
