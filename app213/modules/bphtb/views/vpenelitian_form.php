...
function calculate() {
    ...
    var tarif = parseInt($("#tarif").autoNumeric('get'));
...
$(document).ready(function () {
    ...
    $('#tanggal, #tgl_transaksi, #tgl_jatuh_tempo, #pengurangan_sk_tgl').formatter({
        'pattern': '{{99}}-{{99}}-{{9999}}',
    });
    $('#tanggal, #tgl_transaksi, #tgl_jatuh_tempo, #pengurangan_sk_tgl').datepicker({
        dateFormat:'dd-mm-yy',
        changeMonth:true,
        changeYear:true,
    });
    $('#npopkp, #harga_transaksi, #njop, #njop2, #npop, #bumi_luas, #bumi_njop, #bng_luas, #bng_njop').autoNumeric('init', {
        aSep: '.', aDec: ',', vMin: '-999999999999.99', vMax: '999999999999.99',  mDec: '0'
    });
    $('#npoptkp, #tarif, #terhutang, #bagian, #pembagi, #tarif_pengurang, #pengurang').autoNumeric('init', {
        aSep: '.', aDec: ',', vMin: '-999999999999.99', vMax: '999999999999.99',  mDec: '0'
    });
...
<div class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#"><strong>Penelitian SSPD</strong></a>
            </li>
        </ul>
        ...
        <?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal',
            ...
            <div class="control-group">
                <label class="control-label">No.Transaksi Bank</label>
                <div class="controls">
                    <input class="input-small" type="text" id="transno" name="transno" value="<?=$dt['transno']?>" readonly>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal &nbsp;&nbsp;
                    <input style="width:68px;" type="text" class="input" name="tanggal" id="tanggal" value="<?=$dt['tanggal']; ?>" placeholder="dd-mm-yyyy" readonly>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">PPAT</label>
                <!-- PPAT Boleh diganti2 kata AA karena data IMPORT -->
                <!--div class="controls">
                ...
                <div class="controls">
                    ...
                    <?php if( isset($ppat) && $ppat): ?>
                        <option value="">Silahkan pilih PPAT</option>
                        <?php foreach($ppat as $data): ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="input-xxlarge" name="keterangan" id="keterangan" value="<?=$dt['keterangan']?>" readonly>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="span4" style="width:340px;">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <!--input class="hidden" style="width:16px;" type="text" id="kd_propinsi" name="kd_propinsi" value="<?=$dt['kd_propinsi']?>" maxlength="2">
                                        <input class="hidden" style="width:16px;" type="text" id="kd_dati2" name="kd_dati2" value="<?=$dt['kd_dati2']?>" maxlength="2">
                                        <input class="hidden" style="width:24px;" type="text" id="kd_kecamatan" name="kd_kecamatan" value="<?=$dt['kd_kecamatan']?>" maxlength="3">
                                        <input class="hidden" style="width:24px;" type="text" id="kd_kelurahan" name="kd_kelurahan" value="<?=$dt['kd_kelurahan']?>" maxlength="3">
                                        <input class="hidden" style="width:24px;" type="text" id="kd_blok" name="kd_blok" value="<?=$dt['kd_blok']?>" maxlength="3">
                                        <input class="hidden" style="width:34px;" type="text" id="no_urut" name="no_urut" value="<?=$dt['no_urut']?>" maxlength="4">
                                        <input class="hidden" style="width:16px;" type="text" id="kd_jns_op" name="kd_jns_op" value="<?=$dt['kd_jns_op']?>" maxlength="1">
                                        <label class="label hide">Tahun SPPT</label>
                                        <input class="hidden" style="width:34px;" type="text" id="thn_pajak_sppt" name="thn_pajak_sppt" value="<?=$dt['thn_pajak_sppt']?>" maxlength="4"-->
                                ...
                                <div class="control-group">
                                    <label class="control-label">Mutasi Penuh ?</label>
                                    <div class="controls">
                                    <input type="checkbox" <? echo $dt['mutasi_penuh']?'checked':''?> name="mutasi_penuh">
                                    </div>
                                </div>

                                <!--div class="control-group">
                                    <label class="control-label">Status Kepemilikan XXX</label>
                                    <div class="controls">
                                        <input class="input" type="text" id="xxx" name="xxx" value="">
                                    </div>
                                </div-->
                            </div>
                            <div class="span6">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php if( isset($dasar) && $dasar): ?>
                                            <option value="">Silahkan pilih Dasar Perhitungan</option>
                                    ...
                                    <div class="controls">
                                        <select class="input input-xlarge" name="perolehan_id" id="perolehan_id" >
                                            <?php if( isset($perolehan) && $perolehan): ?>
                                                <option value="">Silahkan pilih Jenis Perolehan</option>
            ...
            <p>&nbsp;</p>
            <button type="submit" id="btn_proses" class="btn btn-primary"><? echo ($this->uri->segment(3)!='edit') ? 'Proses' : 'Simpan'; ?></button>
