...
$(document).ready(function() {
	...
	$('#tgl_ajb, #tgl_pph, #verifikasi_bphtb_date').datepicker({
		dateFormat:'dd-mm-yy',
	});
...
<div class="content">
    <div class="container-fluid">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#"><strong>Verifikasi BPHTB</strong></a>
			</li>
		</ul>
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal','enctype'=>'multipart/form-data'));?>
			...
			<div class="control-group">
				<label class="control-label">Tanggal Verifikasi BPHTB</label>
				<div class="controls">
					<input class="input-small" type="text" id="verifikasi_bphtb_date" name="verifikasi_bphtb_date" value="<?=$dt['verifikasi_bphtb_date']?>" placeholder="dd-mm-yyyy">
				</div>
			</div>
