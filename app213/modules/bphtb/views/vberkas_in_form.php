...
$(document).ready(function() {
	...
	$("#myform").submit(function(eventObj){
		if ($('#pengirim').val()=='' || $('#tgl_terima').val()=='' ) {
		...
		<?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal'));?>
			...
			<div class="control-group">
				...
				<div class="controls">
                    ...
                    &nbsp;&nbsp;&nbsp;Tgl. Terima&nbsp;
					<input class="input" type="text" name="tgl_terima" id="tgl_terima" value="<?=!empty($dt['tgl_terima']) ? $dt['tgl_terima'] : date('d-m-Y'); ?>" style="width:68px;" placeholder="dd-mm-yyyy"/>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-xlarge" style="width:256px;" type="text" name="pengirim" id="pengirim" value="<?=$dt['pengirim']?>" />
				</div>
			</div>
			<div class="control-group">
