...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input style="width:145px;" type="text" id="nop" class="input" 
                       value="<?=($nop != 0 ? $nop : '');?>" name="nop" autocomplete="off"
                       required="required" placeholder="00.00.000.000.000-0000.0" size="30"/>
