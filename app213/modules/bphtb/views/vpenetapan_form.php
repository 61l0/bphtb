...
$(document).ready(function () {
    ...
    $('#tanggal, #tgl_transaksi, #tgl_jatuh_tempo').formatter({
        'pattern': '{{99}}-{{99}}-{{9999}}',
    });
    $('#tanggal, #tgl_transaksi, #tgl_jatuh_tempo').datepicker({
        dateFormat:'dd-mm-yy',
        changeMonth:true,
        changeYear:true,
    });
    ...
    $('#dasar_id, #tgl_transaksi, #tgl_jatuh_tempo, #keterangan, #btn_proses, #btn_cancel').removeAttr('disabled');
    $('#perolehan_id').toggleOption(false);
});
...
<div class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#"><strong>Penetapan SKPD-KB/LB</strong></a>
            </li>
        </ul>
        ...
        <?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal',
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal &nbsp;&nbsp;
                    <input style="width:68px;" type="text" class="input" name="tgl_sspd" id="tgl_sspd" value="<?=($dt['tgl_sspd'])? $dt['tgl_sspd'] : date('d-m-Y'); ?>" placeholder="dd-mm-yyyy" readonly>
                </div>
            </div>
            <!--div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input style="width:68px;" type="text" class="input" name="tgl_transaksi" id="tgl_transaksi" value="<?=date('d-m-Y');?>" placeholder="dd-mm-yyyy">
                    &nbsp;&nbsp;&nbsp;&nbsp;Tgl. Jatuh Tempo &nbsp;&nbsp;
                    <input style="width:67px;" type="text" class="input" name="tgl_jatuh_tempo" id="tgl_jatuh_tempo" value="<?=date('d-m-Y', strtotime('+30 days')); ?>" placeholder="dd-mm-yyyy">
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in" id="op">
                        ...
                        <div class="row">
                            <div class="span4" style="width:340px;">
                                <div class="control-group">
                                    <label class="control-label">NOP - Thn. SPPT</label>
                                    <div class="controls">
