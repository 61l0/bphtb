...
$(document).ready(function () {
    ...
    $('#bpn_tgl_terima, #bpn_tgl_selesai').datepicker({
        dateFormat:'dd-mm-yy',
        changeMonth:true,
        changeYear:true,
    });
    ...
    $('#bpn_tgl_terima, #bpn_tgl_selesai, #btn_proses, #btn_cancel').removeAttr('disabled');
...
<div class="content">
    <div class="container-fluid">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#"><strong>Register Penerimaan SSPD</strong></a>
            </li>
        </ul>
        ...
        <?php echo form_open($faction, array('id'=>'myform','class'=>'form-horizontal',
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input style="width:68px;" type="text" class="input" name="bpn_tgl_terima" id="bpn_tgl_terima" value="<?=($dt['bpn_tgl_terima'])? $dt['bpn_tgl_terima'] : date('d-m-Y'); ?>" placeholder="dd-mm-yyyy">
                    <!--&nbsp;&nbsp;&nbsp;&nbsp;Tgl. Selesai &nbsp;&nbsp;
                    <input style="width:67px;" type="text" class="input" name="bpn_tgl_selesai" id="bpn_tgl_selesai" value="09-06-2015" placeholder="dd-mm-yyyy"-->
                </div>
            </div>
