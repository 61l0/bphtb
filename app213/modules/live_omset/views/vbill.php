...
$(document).ready(function() {	
	oTable = $('#table1').dataTable({
		...
		"aaSorting": [[ 1, "asc" ]],
		"aoColumnDefs": [			
			{ "aTargets": [0], "bSearchable": true,  "bVisible": false, "sWidth": "50px", "sClass": "" },
			{ "aTargets": [1], "bSearchable": true,  "bVisible": true,  "sWidth": "120px", "sClass": "" },
			...
			{ "aTargets": [5], "bSearchable": true,  "bVisible": true,  "sWidth": "80px", "sClass": "right" },
			{ "aTargets": [6], "bSearchable": true,  "bVisible": true,  "sWidth": "120px", "sClass": "" },
		],
