        ...
        <div class="row">
            ...
            <div class="span9">
                    ...
                    <div class="span4" style="width:340px;">
                        ...
                        <div class="form-horizontal">
                            <div class="control-group" id="bphtb_op_alamat">
                                ...
                                <div class="controls">
                                    <input type="text" class="input" value="" value="" name="op_alamat" id="op_alamat">
                                </div>
                            </div>
                            <div class="control-group" id="bphtb_op_blok_kav">
                                <label class="control-label">BLok/Kav</label>
                                <div class="controls">
                                    <input type="text" class="input" value="" value="" name="op_blok_kav" id="op_blok_kav">
                                </div>
                            </div>
                    ...
                    <div class="span4" style="width:340px;">
                        ...
                        <div class="form-horizontal">
                            <div class="control-group" id="sismiop_op_alamat">
                                <label class="control-label">Letak OP</label>
                                <div class="controls">
                                    <input type="text" class="input" value="" value="" name="op_alamat2" id="op_alamat2">
                                </div>
                            </div>
                            <div class="control-group" id="sismiop_op_blok_kav">
                                <label class="control-label">BLok/Kav</label>
                                <div class="controls">
                                    <input type="text" class="input" value="" value="" name="op_blok_kav2" id="op_blok_kav2">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="span8">
                        <hr/>
                        <button id="btn_update" class="btn btn-primary" type="button">Update</button>
